...
export default function TVDetailsPage() {
    ...
    return (
        ...
        <main className="min-h-screen bg-bg-main pb-20">
            ...
            <div className="container mx-auto px-6 lg:px-20 -mt-[40vh] relative z-10">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="flex-1 space-y-8 pt-10">
                        <div>
                            ...
                            <p className="text-xl text-text-secondary italic font-light mb-6">"{show?.tagline || 'TV Series'}"</p>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4 overflow-x-auto horizontal-scroll pb-4">
                                ...
                                )) : <p className="text-text-secondary">No cast information available.</p>}
                            </div>
                        </div>
                                ...
                                <div className="flex gap-4 mb-6 border-b border-white/10">
                                    {trailers.length > 0 && (
                                        <button
                                            ...
                                            className={`px-4 py-2 font-medium transition-all relative ${
                                                activeTab === 'trailers' ? 'text-white' : 'text-text-muted hover:text-white'
                                            }`}
                                        >
                                    ...
                                    {clips.length > 0 && (
                                        <button
                                            ...
                                            className={`px-4 py-2 font-medium transition-all relative ${
                                                activeTab === 'clips' ? 'text-white' : 'text-text-muted hover:text-white'
                                            }`}
                                        >
                                            Clips ({clips.length})
                                            {activeTab === 'clips' && (
                                    ...
                                    {behindScenes.length > 0 && (
                                        <button
                                            ...
                                            className={`px-4 py-2 font-medium transition-all relative ${
                                                activeTab === 'behind' ? 'text-white' : 'text-text-muted hover:text-white'
                                            }`}
                                        >
                ...
                <div className="mt-20 border-t border-white/5 pt-12">
                    <h3 className="text-xl font-display font-bold text-white mb-6">Similar Shows</h3>
                    <div className="flex gap-6 overflow-x-auto hide-scrollbar pb-6 px-1">
                        {similar && similar.length > 0 ? similar.map((m: any) => (
                            <div key={m.id} className="min-w-[160px] group relative">
                                <Link href={`/tv/${m.id}`}>
                                    <div className="aspect-[2/3] relative rounded-xl bg-neutral-800 overflow-hidden mb-2">
                                        {m.poster_path && (
                                            <Image
                                    ...
                                    <h4 className="text-white font-medium group-hover:text-accent-primary transition-colors line-clamp-1">{m.name}</h4>
                                    <div className="flex items-center gap-2 text-xs text-text-muted">
                                        <span>{m.first_air_date?.split("-")[0]}</span>
                                        <span className="flex items-center gap-1 text-accent-primary"><Star size={10} fill="currentColor" /> {m.vote_average.toFixed(1)}</span>
                                    </div>
                                </Link>
                            </div>
                        )) : <p className="text-text-secondary">No similar shows found.</p>}
                    </div>
                </div>
            </div>
        </main>
