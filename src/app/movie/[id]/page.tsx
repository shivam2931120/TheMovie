...
import { Play, Plus, Star, Calendar, Clock, X, Check, DollarSign, Award, MapPin, Music, Film, ChevronLeft, ChevronRight, MessageSquare, Tag, User } from "lucide-react";
...
export default function MovieDetailsPage() {
    ...
    if (!movie) return (
        <div className="min-h-screen bg-bg-main flex items-center justify-center">
            <div className="text-center">
                ...
                <p className="text-text-muted">This movie might have been removed or doesn't exist.</p>
            </div>
        </div>
    );
    ...
    const usCertification = movie.release_dates?.results?.find((r: any) => r.iso_3166_1 === 'US')?.release_dates?.[0]?.certification;
