        ...
        <section className="relative py-20">
            <div className="container px-6 lg:px-20 mx-auto">
                <div className="flex items-center justify-between mb-10">
                    ...
                    <Link href="/movies" className="flex items-center gap-1 text-sm font-medium text-neutral-400 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-accent-primary rounded-lg px-2 py-1">
