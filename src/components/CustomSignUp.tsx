            ...
            <div className="min-h-screen flex items-center justify-center bg-bg-main px-4 sm:px-6 py-12">
                <div className="w-full max-w-md">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-text-secondary">We sent a code to {email}</p>
                    </div>
        ...
        <div className="min-h-screen flex items-center justify-center bg-bg-main px-4 sm:px-6 py-12">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-text-secondary">Start with Google or use email.</p>
                </div>
                ...
                <div className="bg-bg-card border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full bg-white text-black hover:bg-white/90 border border-white/10 font-bold py-3 rounded-lg transition-all flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-3 bg-bg-card text-text-muted">or use email</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 text-center text-sm text-text-muted">
                        ...
                        <Link href="/sign-in" className="text-accent-primary hover:text-accent-primary/80 font-medium transition-colors">
                            Sign in
                        </Link>
                    </div>
                </div>
