...
function Navbar() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b", isScrolled ? "bg-black/80 backdrop-blur-xl border-white/5 py-4" : "bg-transparent border-transparent py-6"),
        ...
        "WatchlistProvider.useCallback[add]": (item)=>{
            ...
            setItems({
                "WatchlistProvider.useCallback[add]": (prev)=>prev.find({
                        "WatchlistProvider.useCallback[add]": (m)=>m.id === item.id && m.type === itemWithType.type
        ...
        "WatchlistProvider.useCallback[toggle]": (item)=>{
            ...
            setItems({
                "WatchlistProvider.useCallback[toggle]": (prev)=>prev.find({
                        "WatchlistProvider.useCallback[toggle]": (m)=>m.id === item.id && m.type === itemWithType.type
...
"[project]/src/context/watched-core.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
;
const WatchedContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$react$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@clerk/shared/dist/runtime/react/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$watched$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/watched-core.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
function WatchedProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WatchedProvider.useEffect": ()=>{
            ...
            if (isSignedIn && user) {
                ...
                const migratedItems = userWatched.map({
                    "WatchedProvider.useEffect.migratedItems": (item)=>{
                        if (item.type) return item; // Already has type
                        const isTv = item.name && !item.title || item.image?.medium || item.premiered;
                        return {
                            ...item,
                ...
                }["WatchedProvider.useEffect.migratedItems"]);
    ...
    const add = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WatchedProvider.useCallback[add]": (item)=>{
            const itemWithType = {
                ...item,
                type: item.type || 'movie',
            ...
            setItems({
                "WatchedProvider.useCallback[add]": (prev)=>prev.find({
                        "WatchedProvider.useCallback[add]": (m)=>m.id === item.id && m.type === itemWithType.type
                    }["WatchedProvider.useCallback[add]"]) ? prev : [
                        itemWithType,
                        ...prev
                    ]
            }["WatchedProvider.useCallback[add]"]);
        }
    }["WatchedProvider.useCallback[add]"], []);
    const remove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WatchedProvider.useCallback[remove]": (id, type = 'movie')=>setItems({
                "WatchedProvider.useCallback[remove]": (prev)=>prev.filter({
                        "WatchedProvider.useCallback[remove]": (m)=>!(m.id === id && m.type === type)
                    }["WatchedProvider.useCallback[remove]"])
            }["WatchedProvider.useCallback[remove]"])
    }["WatchedProvider.useCallback[remove]"], []);
    const toggle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WatchedProvider.useCallback[toggle]": (item)=>{
            const itemWithType = {
                ...item,
                type: item.type || 'movie',
                watchedAt: item.watchedAt || new Date().toISOString()
            ...
            setItems({
                "WatchedProvider.useCallback[toggle]": (prev)=>prev.find({
                        "WatchedProvider.useCallback[toggle]": (m)=>m.id === item.id && m.type === itemWithType.type
                    }["WatchedProvider.useCallback[toggle]"]) ? prev.filter({
                        "WatchedProvider.useCallback[toggle]": (m)=>!(m.id === item.id && m.type === itemWithType.type)
                    }["WatchedProvider.useCallback[toggle]"]) : [
                        itemWithType,
                        ...prev
                    ]
            }["WatchedProvider.useCallback[toggle]"]);
    ...
    const has = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WatchedProvider.useCallback[has]": (id, type = 'movie')=>items.some({
                "WatchedProvider.useCallback[has]": (m)=>m.id === id && m.type === type
            }["WatchedProvider.useCallback[has]"])
    }["WatchedProvider.useCallback[has]"], [
        items
    ]);
    const movies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WatchedProvider.useMemo[movies]": ()=>items.filter({
                "WatchedProvider.useMemo[movies]": (i)=>i.type === 'movie' || !i.type
            }["WatchedProvider.useMemo[movies]"])
    }["WatchedProvider.useMemo[movies]"], [
        items
    ]);
    const tvShows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WatchedProvider.useMemo[tvShows]": ()=>items.filter({
                "WatchedProvider.useMemo[tvShows]": (i)=>i.type === 'tv'
            }["WatchedProvider.useMemo[tvShows]"])
    }["WatchedProvider.useMemo[tvShows]"], [
        items
    ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$watched$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WatchedContext"].Provider, {
        value: value,
        children: children
    }, void 0, false, {
...
_s(WatchedProvider, "dX3yReK0CwSO6nmYPCzTI5w29Kg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$react$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"]
    ];
});
...
//# sourceMappingURL=src_9875235e._.js.map